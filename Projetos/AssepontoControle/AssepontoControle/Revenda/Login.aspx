    ...
    <table style="width: 100%;     border-top: 2px solid #E4E6E7;">
        <tr>
            <td style="vertical-align: top; width: 800px;" class="text">
                <p>
                    <img src="../Images/AssepontoWeb/chegou-a-nova-versao.png" style="width:100%" />
                    <%--<img src="../Images/Logos/logoRevendasGold.png" width="450" />--%>
                </p>
                <div style="width:70%;float:none;margin: 0px auto">
                    <img src="../Images/Logos/logoAssepontoWeb1.png" style="width:100%" />
                </div>
                <p>O Software mais completo para gestão e apuração de ponto está agora na <b>Versão 100% WEB.</b> Agora as empresas poderão acessar, consultar, gerenciar, tratar o ponto, emitir relatórios... 
                    de qualquer parte do mundo.
                   <asp:HyperLink ID="hlinkGold" runat="server" ForeColor="#0086E7" NavigateUrl="http://www.assecont.com.br/tecnologia/AssepontoWeb/" 
                       Target="_blank" Text="Clique aqui para saber mais..." />
                </p>
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/pPW40DbT0Ug" frameborder="0" allowfullscreen></iframe>
                <%--<p>
