<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Assecont.Master" AutoEventWireup="true"
    CodeBehind="Pendencia.aspx.cs" Inherits="Asseponto.Suporte.Implantacoes.Pendencia" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentplaceConteudo" runat="server">
    ...
    <asp:SqlDataSource ID="sqlPendencias" runat="server" ConnectionString="<%$ ConnectionStrings:AppConnectionString %>"
        ...
        InsertCommand="INSERT INTO AssepontoPendencias (PEN_INDCADASTRO, PEN_RESPONSAVEL1, PEN_RESPONSAVEL2, PEN_SOLICITANTE, PEN_PROBLEMA, PEN_SOLUCAO, PEN_DATAHORA, PEN_DATAHORASOLUCAO, PEN_SITUACAO, PEN_TIPO, PEN_IMPLANTACAO) 
                VALUES (@PEN_INDCADASTRO, @PEN_RESPONSAVEL1, @PEN_RESPONSAVEL2, @PEN_SOLICITANTE, @PEN_PROBLEMA, @PEN_SOLUCAO, GETDATE(), @PEN_DATAHORASOLUCAO, @PEN_SITUACAO, @PEN_TIPO, @PEN_IMPLANTACAO)"
