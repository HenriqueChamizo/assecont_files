...
<asp:Content ID="Content2" ContentPlaceHolderID="contentplaceMenuEsquerdo" runat="server">
    <div id="sitemenuesquerdo">
        <telerik:RadMenu ID="RadMenu2" runat="server" Flow="Vertical" Skin="Wr" EnableEmbeddedSkins="false"
            Width="100%">
            <Items>
                <telerik:RadMenuItem runat="server" Text="Novo Pedido Asseponto4" NavigateUrl="~/suporte/pedidos/pedido.aspx"></telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Novo Pedido AssepontoWeb" NavigateUrl="~/suporte/pedidos/PontoWeb.aspx"></telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Novo Pedido Assefin" NavigateUrl="~/suporte/pedidos/Assefin.aspx"></telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Em Aberto Asseponto4" NavigateUrl="#"></telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Em Aberto AssepontoWeb" NavigateUrl="#"></telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Em Aberto Assefin" NavigateUrl="#"></telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Fechados Asseponto4" NavigateUrl="#"></telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Fechados AssepontoWeb" NavigateUrl="#"></telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Fechados Assefin" NavigateUrl="#"></telerik:RadMenuItem>
            </Items>
        </telerik:RadMenu>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="contentplaceConteudo" runat="server">
    ...
    <asp:SqlDataSource ID="sqlAssepontoPedidosRevendas" runat="server" ConnectionString="<%$ ConnectionStrings:AppConnectionString %>"
        SelectCommand="SELECT [PED_IND], [REV_RAZAOSOCIAL], [PED_CLI_RAZAO], RTRIM(FABR_NOME) + ': ' + PED_MODELOREP AS REP, [PED_DATA], 
	                          [PED_FANTASIA], [PED_ASSEFIN], [VERS4_DESCRICAO], [PED_ASSEPONTO4], [SUP_NOME] 
                       ...
                       WHERE PED_STATUS = @STATUS AND (PED_ASSEFIN = @assef OR @assef = 2) AND 
	                         (@FILTRONOME = '*' OR PED_CLI_RAZAO LIKE '%' + @FILTRONOME + '%') AND 
	                         (PED_VERSAO_AQUISICAO = @web or (@web = 0 and PED_VERSAO_AQUISICAO != 8))
        ...
        <SelectParameters>
            ...
            <asp:QueryStringParameter Name="web" QueryStringField="web" Type="Int32" DefaultValue="0" />
