        ...
        <div style="top: 180px; /*position: absolute;*/">
            <div id="DivImpressao">
                ...
                <section id="AtestadoTecnico">
                    <asp:Image ID="imgAtestado" ImageUrl="" runat="server" class="imgAtestadoTecnico" Height="685" />
                    <div class="txtAtestadoTecnico">
                        <div style="text-align: justify; font-family: Ebrima; font-size: 10pt;">
                            ...
                            <br />
                            programa de registro de ponto eletrônico denominado <%--ASSEPONTO versão 4--%><asp:Label ID="lbVersao" runat="server" Text=""></asp:Label> está em conformidade com a Portaria
                            <br />
