<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Revenda.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="Asseponto.Revenda.Clientes.Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentplaceConteudo" runat="server">
    <div id="sitecorpobox">
        <div id="sitecorpoboxinner">
            <wr:TextSearch ID="TextSearch1" runat="server" PostBackUrl="~/Revenda/clientes/default.aspx"
            ...
            <telerik:RadListView ID="RadListView1" runat="server" DataKeyNames="CAD_IND" DataSourceID="SqlClientes"
                ...
                <ItemTemplate>
                    <fieldset class="sitelistviewfieldsetitemtemplate">
                        <b>
                            <asp:HyperLink ID="HyperLink1" runat="server" CssClass="sitelinkpadraoazul" NavigateUrl='<%# Eval("CAD_IND", "~/revenda/clientes/cliente.aspx?ind={0}") %>'><%# Eval("CAD_RAZAOSOCIAL")%></asp:HyperLink></b><br />
    ...
    <asp:SqlDataSource ID="SqlClientes" runat="server" ConnectionString="<%$ ConnectionStrings:AppConnectionString %>"
        SelectCommand="SELECT [CAD_IND], [CAD_RAZAOSOCIAL], [CAD_TELEFONE1], [CAD_CONTATO], [CAD_EMAIL], [CAD_CIDADE], [CAD_EMAIL2] 
        FROM [AssepontoClientes] 
        WHERE CAD_REVENDA = @REVENDA AND (@FILTRONOME = '*' OR CAD_RAZAOSOCIAL LIKE '%' + @FILTRONOME + '%') AND 
        (@FILTROFANTASIA = '*' OR CAD_FANTASIA LIKE '%' + @FILTROFANTASIA + '%') 
