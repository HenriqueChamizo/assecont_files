<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Revenda.Master" AutoEventWireup="true" CodeBehind="RelatorioClientesExpirados.aspx.cs" Inherits="Asseponto.Revenda.Relatorios.RelatorioClientesExpirados" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentplaceConteudo" runat="server">
                    ...
                    <MasterTableView DataSourceID="SqlDataClientesExpirados" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn DataField="CAD_RAZAOSOCIAL"
                                ...
                                <ItemTemplate>
                                    <asp:HyperLink ID="lbRazaoSocial" runat="server" Target="_blank" CssClass="sitelinkpadraoazul" NavigateUrl='<%# Eval("CAD_IND", "~/revenda/Atendimento/Cliente.aspx?ind={0}") %>' Text='<%# Eval("CAD_RAZAOSOCIAL")%>'> </asp:HyperLink></b>
                                    <br />
    ...
    <asp:SqlDataSource ID="SqlDataClientesExpirados" runat="server" ConnectionString="<%$ ConnectionStrings:AppConnectionString %>"
        SelectCommand="SELECT CAD_IND, CAD_RAZAOSOCIAL, CAD_DTA_COMUNICADO, CAD_EMAIL, REV_RAZAOSOCIAL, CAD_EMAIL2, NSE_DATA, 
                        ...
                        WHERE REV_IND = @REVENDA and --dbo.fn_asseponto_cliente_tem_manutencao_ativa(CAD_IND) = 0 AND 
	                        (MONTH(NSE_DATA)= @ind AND YEAR(NSE_DATA) = @ano) AND
	                        DATEDIFF(DAY, NSE_DATA, GETDATE()) > 60 
                        ORDER BY NSE_DATA">
        <SelectParameters>
