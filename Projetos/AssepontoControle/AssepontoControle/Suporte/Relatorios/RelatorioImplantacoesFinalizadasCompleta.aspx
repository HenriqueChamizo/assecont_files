<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Assecont.Master" AutoEventWireup="true" CodeBehind="RelatorioImplantacoesFinalizadasCompleta.aspx.cs" Inherits="Asseponto.Suporte.Relatorios.RelatorioImplantacoesFinalizadasCompleta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentplaceMenuEsquerdo" runat="server">
    <div id="sitemenuesquerdo">
        <telerik:RadMenu ID="RadMenu1" runat="server" Flow="Vertical" Skin="Wr" EnableEmbeddedSkins="false"
            ...
            <Items>
                <telerik:RadMenuItem runat="server" Text="Janeiro">
                </telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Fevereiro">
                </telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Março">
                </telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Abril">
                </telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Maio">
                </telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Junho">
                </telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Julho">
                </telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Agosto">
                </telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Setembro">
                </telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Outubro">
                </telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Novembro">
                </telerik:RadMenuItem>
                <telerik:RadMenuItem runat="server" Text="Dezembro">
                </telerik:RadMenuItem>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentplaceConteudo" runat="server">
        ...
        <div id="sitecorpoboxinner" style="margin-left: 10px">
                ...
                <asp:FormView ID="FormViewQtdFinalizadas" runat="server" DataSourceID="SqlDataQtdFinalizadas" Font-Size="12pt" DefaultMode="Edit">
                    <EditItemTemplate>
                        ...
                        <br />
                        <asp:Label ID="lbqtdevidada" runat="server"  Text='<%# Eval("QtdFinalizadas") + " Implantações finalizadas" %>'></asp:Label>
                    </EditItemTemplate>
                </asp:FormView>
            </p>
            ...
            <asp:DataList ID="DataListQtdFinalizadas" runat="server" DataSourceID="SqlDataImplantacaoesFinalizadas" BorderStyle="None" CellSpacing="20" EnableTheming="True"
                ...
                <ItemTemplate>
                    <table>
                        ...
                        <tr>
                            <td>Data do Cadastro: 
                                <asp:Label ID="lbDataFializado" runat="server" Text='<%# Eval("IM_INICIO", "{0:dd/MM/yyyy}") %>'></asp:Label>
                                <br />
                                Data da finalização: 
                                <asp:Label ID="lbDataCadastro" runat="server" Text='<%# Eval("IM_TERMINO", "{0:dd/MM/yyyy}") %>'></asp:Label>
                                <br />
                                Relogio
    ...
    <asp:SqlDataSource ID="SqlDataImplantacaoesFinalizadas" runat="server" ConnectionString="<%$ ConnectionStrings:AppConnectionString %>"
        SelectCommand="SELECT * FROM AssepontoClientes
                       ...
                       LEFT JOIN AssepontoRepFabricantes ON IM_REP_FABRICANTE = FABR_COD
