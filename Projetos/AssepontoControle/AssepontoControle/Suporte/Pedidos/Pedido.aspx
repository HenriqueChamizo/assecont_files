<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Assecont.Master" AutoEventWireup="true"
    CodeBehind="Pedido.aspx.cs" Inherits="Asseponto.Suporte.Pedidos.Pedido" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentplaceConteudo" runat="server">
            ...
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="PED_IND" DataSourceID="sqlPedidosRevendas" OnDataBound="FormView1_DataBound">
                <EditItemTemplate>
                    <asp:Panel ID="Panel1" runat="server" EnableViewState="false">
                        <asp:HiddenField ID="hiddenRevenda" runat="server" Value='<%# Bind("PED_REV_IND") == null ? "0" : Bind("PED_REV_IND") %>' />
                                    ...
                                    <table class="formviewtableinner">
                                        <tr>
                                            <td>
                                                ...
                                                <telerik:RadComboBox ID="comboboxRevenda" runat="server" 
                                                    SelectedValue='<%# Bind("PED_REV_IND") %>' Width="500px" EmptyMessage="Selecione a Revenda" 
                                                    DataSourceID="sqlRevendas" DataTextField="REV_RAZAOSOCIAL" DataValueField="REV_IND"
                                                    notnull="false" Skin="flv" EnableEmbeddedSkins="false">
                                                </telerik:RadComboBox>
    ...
    <asp:SqlDataSource ID="sqlPedidosRevendas" runat="server" ConnectionString="<%$ ConnectionStrings:AppConnectionString %>"
        SelectCommand="SELECT PED_IND, PED_DATA, PED_DATAFECHAMENTO, PED_PLANILHA_EXCEL, case when PED_REV_IND = 0 then null else PED_REV_IND end as PED_REV_IND , PED_CLI_RAZAO , PED_CLI_CNPJ , PED_CLI_CPF , PED_CLI_IE , PED_CLI_ENDERECO , PED_CLI_ENDERECO_NUMERO, PED_CLI_ENDERECO_COMPLEMENTO, 
