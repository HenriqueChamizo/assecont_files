...
<asp:content id="Content2" contentplaceholderid="contentplaceMenuEsquerdo" runat="server">
    <div id="sitemenuesquerdo">
        ...
        <div>
            <style>
                body{
                    font: 10pt 'Segoe UI', 'Segoe UI Light' !important;
                    margin: 0px;
                    padding: 0px;
                    overflow: auto !important;
                    background-color: white;
                    color: #292929;
                    border-top: 3px solid #EF3737;
                }
                .sidebar .sidebar-menu li a{
                    color: dimgray;
                }
            </style>
            <link rel="stylesheet" href="../../Skins/Admin/dist/css/AdminLTE.min.css">
            <section class="sidebar">
                <ul class="sidebar-menu">
                    <li class="treeview">
                        <a href="#">
                            <%--<i class="fa fa-dashboard"></i>--%> <span>Asseponto 4</span>
                            <%--<span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>--%>
                        </a>
                        <ul id="ponto4" runat="server" class="treeview-menu">
                            <li><asp:LinkButton ID="pontoLink1" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=1&andam=6&filtronome=*&iniciadas=2" Text=" - Primeiro Contato" /></li>  
                            <li><asp:LinkButton ID="pontoLink2" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=1&andam=1&filtronome=*&iniciadas=2" Text=" - Aguardando Planilha" /></li>
                            <li><asp:LinkButton ID="pontoLink3" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=1&andam=2&filtronome=*&iniciadas=2" Text=" - Aguardando Treinamento" /></li>
                            <li><asp:LinkButton ID="pontoLink4" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=1&andam=4&filtronome=*&iniciadas=2" Text=" - REP Manutenção" /></li>
                            <li><asp:LinkButton ID="pontoLink5" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=1&andam=5&filtronome=*&iniciadas=2" Text=" - Retorno do Cliente" /></li>
                            <li><asp:LinkButton ID="pontoLink6" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=100&andam=8&filtronome=*&iniciadas=2" Text=" - Repassado para revenda <br /> (Finalizado)" /></li>
                            <li><asp:LinkButton ID="pontoLink7" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=1&andam=9&filtronome=*&iniciadas=2&tip=0" Text=" - Agendamento" /></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                            <%--<i class="fa fa-dashboard"></i>--%> <span>Asseponto Web</span>
                            <%--<span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>--%>
                        </a>
                        <ul id="web" runat="server" class="treeview-menu">
                            <li><asp:LinkButton ID="webLink1" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=1&andam=6&filtronome=*&iniciadas=2&WEB=1" Text=" - Primeiro Contato" /></li>
                            <li><asp:LinkButton ID="webLink2" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=1&andam=1&filtronome=*&iniciadas=2&WEB=1" Text=" - Aguardando Planilha" /></li>
                            <li><asp:LinkButton ID="webLink3" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=1&andam=2&filtronome=*&iniciadas=2&WEB=1" Text=" - Aguardando Treinamento" /></li>
                            <li><asp:LinkButton ID="webLink4" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=1&andam=4&filtronome=*&iniciadas=2&WEB=1" Text=" - REP Manutenção" /></li>
                            <li><asp:LinkButton ID="webLink5" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=1&andam=5&filtronome=*&iniciadas=2&WEB=1" Text=" - Retorno do Cliente" /></li>
                            <li><asp:LinkButton ID="webLink6" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=100&andam=8&filtronome=*&iniciadas=2&WEB=1" Text=" - Repassado para revenda <br /> (Finalizado)" /></li>
                            <li><asp:LinkButton ID="webLink7" runat="server" PostBackUrl="~/suporte/implantacoes/default.aspx?status=1&andam=9&filtronome=*&iniciadas=2&tip=0&WEB=1" Text=" - Agendamento" /></li>
                        </ul>
                    </li>
                </ul>
            </section>
            <script src="../../Skins/Admin/plugins/jQuery/jquery-2.2.3.min.js"></script>
            <script src="../../Skins/Admin/dist/js/app.min.js"></script>
...
<asp:content id="Content3" contentplaceholderid="contentplaceConteudo" runat="server">
    ...
    <asp:SqlDataSource ID="SqlImplantacoes" runat="server" ConnectionString="<%$ ConnectionStrings:AppConnectionString %>"
        SelectCommand="SELECT IM_IND, REV_RAZAOSOCIAL, IM_INICIO, IM_ANDAMENTO, STAT_NOME, TIPO_STAT_NOME, IM_TERMINO, CAD_FANTASIA, 
                        CAD_RAZAOSOCIAL, SUP_NOME, IM_STATUS, IM_INICIO_IMPLANTACAO, IM_DTAGENDA, IM_ASSEFIN, IM_ASSEPONTO4, IM_ASSEPONTOWEB, 
                        ...
                        AND (@web = 2 OR IM_ASSEPONTOWEB = @web OR (@web = 1 AND IM_VERSAO = 8))
        ...
        <SelectParameters>
            ...
            <asp:QueryStringParameter Name="web" QueryStringField="web" DefaultValue="2" />
