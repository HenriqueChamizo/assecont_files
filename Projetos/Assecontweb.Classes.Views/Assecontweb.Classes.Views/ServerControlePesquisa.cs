...
namespace Assecontweb.Classes.Views
{
    ...
    [System.Web.UI.ToolboxData("<{0}:ServerControlePesquisa runat=server></{0}:ServerControlePesquisa>")]

    public class ServerControlePesquisa : RadGrid
    {
        [Bindable(true)]
        [Category("Appearance")]
        [DefaultValue("")]
        ...
        protected override void CreateChildControls()
        {
            ...
            sqlData.SelectCommand = string.Format("SET DATEFORMAT DMY EXEC rs_questionario_obrigacoes @P_DATA_INICIAL = '{0}', @P_DATA_FINAL = '{1}', @P_LOGININTERNO = {2}, @P_SETOR = {3} ", DataInicial.ToString("dd/MM/yyyy"), DataFinal.ToString("dd/MM/yyyy"), login, (int)setor);
