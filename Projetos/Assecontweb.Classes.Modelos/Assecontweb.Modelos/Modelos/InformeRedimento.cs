...
namespace Assecontweb.Modelos
{
    public class InformeRedimento
    {
        ...
        private void LerArquivo(string fileName, int ObrigacaoClientePeriodo)
        {
            ...
            const int LiquidoOutros = 18;

            /*RendimentosAcumuladamente*/
            const int NumeroProcesso = 19;
            const int QuantMeses = 20;
            const int AcumuladamenteNatureza = 21;
            const int totalTributaveis = 22;
            const int ExclusaoAcaoJudicial = 23;
            const int DeducaoPrevidenciaria = 24;
            const int DeducaoAlimenticia = 25;
            const int ImpostoRetidoFonte = 26;
            const int RendIsentosPensao = 27;

            /*Complementares*/
            const int Complementares = 28;

            /*Responsavel*/
            const int ResponsavelNome = 29;
            const int ResponsavelData = 30;
            const int Assinatura = 31;
            #endregion
