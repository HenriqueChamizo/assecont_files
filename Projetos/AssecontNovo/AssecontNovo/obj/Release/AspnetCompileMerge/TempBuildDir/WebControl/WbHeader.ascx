<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WbHeader.ascx.cs" Inherits="Assecont2.WebControl.WbHeader" %>

<link href="http://www.assecont.com.br/assecont/Skins/Window.flv.css" rel="stylesheet" />
...
<script type="text/javascript">
    function OpenloginAntigo() {
        ...
        //oWnd1.setUrl("http://www.assecont.com.br/assecont/Avisos/AvisoManutencao.html");
        ...
        <ContentTemplate>
            <table style="text-align: left;">
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="RadComboxAcesso" runat="server" Width="110" AutoPostBack="true" Skin="flv"
                            EnableEmbeddedSkins="false" CausesValidation="false" OnSelectedIndexChanged="RadComboxAcesso_SelectedIndexChanged">
                        </telerik:RadComboBox>
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:LinkButton ID="login" runat="server" CausesValidation="false" Style="color: white" OnClick="login_Click">Entrar    | </asp:LinkButton>
                    </td>
                             <td>
                        <a id="lkLoginAntigo" runat="server" style="color: white; cursor: pointer; border: 0px;" href="http://www.assecont.com.br/Assecontwebnovo/login.aspx">Esqueci minha senha    | </a>
                    </td>
                    <td>
                        <a target="_blank" href="http://www.assecont.com.br/assecont/arquivos/PassoNovoLogin.pdf" id="ButtHelp" style="color: white" class="OpenButton">Ajuda</a>
                    </td>
                </tr>
            </table>
        </ContentTemplate>
