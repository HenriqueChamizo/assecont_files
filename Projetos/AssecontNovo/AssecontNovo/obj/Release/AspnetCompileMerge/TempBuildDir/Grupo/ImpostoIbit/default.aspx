<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Assecont.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Assecont2.Grupo.ImpostoIbit._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceWebSite" runat="server">
    <section id="SectiontWebsit" runat="server" style="margin: 0px auto; width: 1030px; min-height: 330px; padding-bottom: 50px;">
        ...
        <section>
            ...
            <br />
            <br />
            <telerik:RadGrid ID="RadGridMensal" DataSourceID="SqlDataTabelaNCM" runat="server" Skin="flv"
                EnableEmbeddedSkins="false" AllowSorting="false" Width="860" AllowMultiRowSelection="False" AllowPaging="false"
                ShowGroupPanel="false" AutoGenerateColumns="False" GridLines="none" ItemStyle-Height="32px" AlternatingItemStyle-Height="32px">
            ...
            <asp:SqlDataSource ID="SqlDataTabelaNCM" runat="server" ConnectionString="<%$ ConnectionStrings:AppConnectionString %>"
