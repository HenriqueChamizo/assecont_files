<%@ Page Title="" Language="C#" MasterPageFile="~/Holerite/ForaDaMaster.Master" AutoEventWireup="true" CodeBehind="ProcurarHolerite.aspx.cs" Inherits="Assecont2.Holerite.ProcurarHolerite" %>
                ...
                <div id="sitecorpobox">
                    <table style="width: 714px; margin-left: 20px; font-family: Calibri; font-size: 14px;">
                        <tr>
                            ...
                            <td style="text-align: right;">Pesquisar por CPF ou Registro (somente números)
                    <div style="padding-right: 55px;">
                        <asp:TextBox ID="txtPesquisar" MaxLength="12" runat="server" OnTextChanged="txtPesquisar_TextChanged"></asp:TextBox>&nbsp;
                        <asp:LinkButton ID="lkProcurar" runat="server" CssClass="sitebutton" OnClick="lkProcurar_Click">Pesquisar</asp:LinkButton>
                    </div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <input type="button" value="Imprimir Holerite" onclick="JavaScript: imprimePanel('DivImpressao');" class="sitebutton" />
                            </td>
                        </tr>
                    </table>
                    <div id="DivImpressao">
                                            ...
                                            <table style="width: 510px; height: 40px; padding-left: 2px; font-family: Tahoma; font-size: 9px;"
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <br />
                                                        <asp:Label ID="Label20" runat="server" Text='<%# Eval("CLI_ENDERECO") %>'></asp:Label>&nbsp;&nbsp;
                                                                     <asp:Label ID="Label36" runat="server" Text='<%# Eval("CLI_ENDERECO_NUMERO") %>'></asp:Label>
                                                        <br />
                                                        <asp:Label ID="Label37" runat="server" Text='<%# Eval("CLI_ENDERECO_MUNICIPIO") %>'></asp:Label>&nbsp;
                                                                    <asp:Label ID="Label38" runat="server" Text="- SP"></asp:Label>&nbsp;&nbsp;&nbsp;
                                                                    <asp:Label ID="Label64" runat="server" Text='<%# Eval("CLI_ENDERECO_CEP", "{0:00.000-000}") %>'></asp:Label>&nbsp;&nbsp;&nbsp;
                                                                    <asp:Label ID="Label18" runat="server" Text='<%# Eval("CNPJ_CPF") %>'></asp:Label>
                                                        <br />
                                                    </td>
                                                </tr>
                                            </table>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:Label ID="Label5" runat="server" Text='<%# Eval("CLI_ENDERECO_MUNICIPIO") %>'></asp:Label>&nbsp;
                                                                    ...
                                                                    <asp:Label ID="Label8" runat="server" Text='<%# Eval("CNPJ_CPF") %>'></asp:Label>
                                                        <br />
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" style="padding-left: 2px; font-family: Tahoma; font-size: 9px;">
                                                <tr>
                                                    ...
                                                    <td style="width: 150px; border-right: 1px solid Black;">
                                                        ...
                                                        <asp:Label ID="Label21" runat="server" Text='<%# Eval("FUNC_BANCO") %>'></asp:Label>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            Creditado
