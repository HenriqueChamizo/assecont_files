<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Accounting.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Assecont2.contabilidade" %>
            ...
            <ul>
                <li>
                    <a href="gestaoContabilidade.aspx" target="_blank">
                        <asp:Image ID="Banner01" runat="server" ImageUrl="http://www.assecont.com.br/assecont/Imagens/Banner/BannerContabil/Banner1.png" alt="Banner 01" />
                    </a>
                </li>
                <li>
                    <a href="gestaoFiscal.aspx" target="_blank">
                        <asp:Image ID="Banner02" runat="server" ImageUrl="http://www.assecont.com.br/assecont/Imagens/Banner/BannerContabil/Banner2.png" alt="Banner 02" />
                    </a>
                </li>
                <li>
                    <a href="gestaoTrabalhista.aspx" target="_blank">
                        <asp:Image ID="Banner03" runat="server" ImageUrl="http://www.assecont.com.br/assecont/Imagens/Banner/BannerContabil/Banner3.png" alt="Banner 03" />
                    </a>
                </li>
                <li>
                    <a href="auditoria.aspx" target="_blank">
                        <asp:Image ID="Banner04" runat="server" ImageUrl="http://www.assecont.com.br/assecont/Imagens/Banner/BannerContabil/Banner4.png" alt="Banner 04" />
                    </a>
                </li>
                <li>
                    <a href="legalizacao.aspx" target="_blank">
                        <asp:Image ID="Banner05" runat="server" ImageUrl="http://www.assecont.com.br/assecont/Imagens/Banner/BannerContabil/Banner5.png" alt="Banner 05" />
                    </a>
                </li>
                <li>
                    <a href="../Grupo/AtendPersonalizado.aspx" target="_blank">
                        <asp:Image ID="Banner06" runat="server" ImageUrl="http://www.assecont.com.br/assecont/Imagens/Banner/BannerContabil/Banner6.png" alt="Banner 06" />
                    </a>
                </li>
                <li>
                    <a href="../Contabilidade/AsseAdmin.aspx" target="_blank">
                        <asp:Image ID="Banner07" runat="server" ImageUrl="http://www.assecont.com.br/assecont/Imagens/Banner/BannerContabil/Banner7.png" alt="Banner 07" />
                    </a>
                </li>
            </ul>
        </div>
                    ...
                    <article style="width: 400px; height: 230px;">
                        ...
                        <p>
                            <asp:HyperLink ID="HyperIntegracao" runat="server" NavigateUrl="../Contabilidade/IntegracaoSistema.aspx" CssClass="sitebutton blue">Saiba mais
                                   <img src="http://www.assecont.com.br/assecont/Imagens/24x24/OpenWhite24x24.png" />
                            </asp:HyperLink>
                        </p>
                    </article>
                </td>
                ...
                <td valign="top" style="width: 230px;">
                    <article class="MiniArticleBox">
                        ...
                        <table style="padding-bottom: 8px;">
                            <tr>
                                <td  class="texto"><a target="_blank" href="http://www.assecont.com.br/assecont/Grupo/HomeOffice.aspx">Trabalhando em casa</a>
                                </td>
                                <td>
