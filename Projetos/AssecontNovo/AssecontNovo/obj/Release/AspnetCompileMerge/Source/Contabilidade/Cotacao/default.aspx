<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Accounting.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Assecont2.Contabilidade.Cotacao._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceWebSite" runat="server">
    ...
    <section class="ContentText">
        ...
        <p>
            <a target="_blank" href="http://www.assecont.com.br/assecont/grupo/NbrIso.aspx" class="sitebutton blue">SISTEMA DE GESTÃO DA QUALIDADE ABNT NBR ISO 9001
                        <img src="http://www.assecont.com.br/assecont/Imagens/24x24/OpenWhite24x24.png" /></a><br />
        </p>
        <p>
            <a target="_blank" href="http://www.assecont.com.br/assecont/grupo/contabeisPqec.aspx" class="sitebutton blue">PROGRAMA DE QUALIDADE DE EMPRESAS CONTÁBEIS - PQEC
            <img src="http://www.assecont.com.br/assecont/Imagens/24x24/OpenWhite24x24.png" /></a><br />
