<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/HoleriteCliente.Master" AutoEventWireup="true" CodeBehind="HoleriteClientes.aspx.cs" Inherits="AssecontNovo.Holerite.HoleriteClientes" %>
...
<%--    <table>
                                            ...
                                            <table style="width: 510px; height: 40px; padding-left: 2px; font-family: Tahoma; font-size: 9px;"
                                                ...
                                                <tr>
                                                    <td>
                                                        <div align="center">
                                                            <b>
                                                                <asp:Label ID="lbTitulo" runat="server" Text='<%# Convert.ToInt16(Eval("SAL_HOLERITE_TIPO")) == 1? "RECIBO DE PAGAMENTO DE SALÁRIO MENSAL" :  Convert.ToInt16(Eval("SAL_HOLERITE_TIPO")) == 3 ? "RECIBO DE ADIANTAMENTO DE SALÁRIO MENSAL" : Convert.ToInt16(Eval("SAL_HOLERITE_TIPO")) == 2 ? "RECIBO DE PRO_LABORE DE SALÁRIO MENSAL" :Convert.ToInt16(Eval("SAL_HOLERITE_TIPO")) == 4 ? "RECIBO DE PRIMEIRA PARCELA 13º SALÁRIO" : Convert.ToInt32(Eval("SAL_HOLERITE_TIPO")) == 5 ? "RECIBO DE SEGUNDA PARCELA 13º SALÁRIO" : Convert.ToInt32(Eval("SAL_HOLERITE_TIPO")) == 6 ? "PARTICIPAÇÃO REMUNERADA NOS RESULTADOS" : "RECIBO DE ABONO" %>'></asp:Label></b>
                                                        </div>
                                                        ...
                                                        <asp:Label ID="Label18" runat="server" Text='<%# Eval("CLI_ENDERECO_MUNICIPIO") %>'></asp:Label>&nbsp;
                                                                    ...
                                                                    <asp:Label ID="Label36" runat="server" Text='<%# Convert.ToInt16(Eval("FUNC_EMPRESA_CPF")) == 0? String.Format(@"{0:00\.000\.000\/0000\-00}", Convert.ToDouble(Eval("CLI_CNPJ"))) : String.Format(@"{0:000\.000\.000\-00}", Convert.ToDouble(Eval("FUNC_CPF"))) %>'></asp:Label>
                                                        <br />
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" style="padding-left: 2px; font-family: Tahoma; font-size: 9px;">
                                                <tr>
                                                    ...
                                                    <td style="width: 380px; border-right: 1px solid Black;">
                                                        ...
                                                        <asp:Label ID="Label42" runat="server" Text='<%# Eval("SAL_NOM") %>'></asp:Label>
                                                    </td>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" style="padding-left: 2px; font-family: Tahoma; font-size: 9px;">
                                                <tr>
                                                    ...
                                                    <td style="width: 150px; border-right: 1px solid Black;">
                                                        ...
                                                        <asp:Label ID="Label45" runat="server" Text='<%# Eval("SAL_BANCO") %>'></asp:Label>
                                                    </td>
                                                    <td style="width: 150px; border-right: 1px solid Black;">
                                                        <div>
                                                            Conta Corrente
                                                        </div>
                                                        <asp:Label ID="Label46" runat="server" Text='<%# Eval("SAL_CONTA") %>'></asp:Label>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            Creditado
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("CLI_ENDERECO_MUNICIPIO") %>'></asp:Label>&nbsp;
                                                                    ...
                                                                    <asp:Label ID="Label65" runat="server" Text='<%# Convert.ToInt16(Eval("FUNC_EMPRESA_CPF")) == 0? String.Format(@"{0:00\.000\.000\/0000\-00}", Convert.ToDouble(Eval("CLI_CNPJ"))) : String.Format(@"{0:000\.000\.000\-00}", Convert.ToDouble(Eval("FUNC_CPF"))) %>'></asp:Label>
                                                        <br />
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" style="padding-left: 2px; font-family: Tahoma; font-size: 9px;">
                                                <tr>
                                                    ...
                                                    <td style="width: 380px; border-right: 1px solid Black;">
                                                        ...
                                                        <asp:Label ID="Label12" runat="server" Text='<%# Eval("SAL") %>'></asp:Label>
                                                    </td>
                                                    <td style="width: 195px;">
                                                        <div>
                                                            Função
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" style="padding-left: 2px; font-family: Tahoma; font-size: 9px;">
                                                <tr>
                                                    ...
                                                    <td style="width: 150px; border-right: 1px solid Black;">
                                                        ...
                                                        <asp:Label ID="Label15" runat="server" Text='<%# Eval("SAL_BANCO") %>'></asp:Label>
                                                    </td>
                                                    <td style="width: 150px; border-right: 1px solid Black;">
                                                        <div>
                                                            Conta Corrente
                                                        </div>
                                                        <asp:Label ID="Label21" runat="server" Text='<%# Eval("SAL_CONTA") %>'></asp:Label>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            Creditado
    ...
    <asp:SqlDataSource ID="SqlDataHolerite" runat="server" ConnectionString="<%$ ConnectionStrings:AppConnectionString %>"
        SelectCommand="SELECT *, 
            (SELECT RTRIM(EVENT_DESCRICAO) + CHAR(10) FROM HoleriteEventos WHERE EVENT_FUNC = FUNC_IND AND EVENT_QUEBRA = SAL_QUEBRA AND (MONTH(EVENT_COMPETENCIA) = @MES) AND YEAR(EVENT_COMPETENCIA) = @ANO AND EVENT_HOLERITE_TIPO = @SAL_HOLERITE_TIPO FOR XML PATH('')) AS EVENTODESCRICAO,
            (SELECT EVENT_CODIGO + CHAR(10) FROM HoleriteEventos WHERE EVENT_FUNC = FUNC_IND AND EVENT_QUEBRA = SAL_QUEBRA AND (MONTH(EVENT_COMPETENCIA) = @MES) AND YEAR(EVENT_COMPETENCIA) = @ANO AND EVENT_HOLERITE_TIPO = @SAL_HOLERITE_TIPO FOR XML PATH('')) AS EVENTOCODIGO,
            (SELECT EVENT_REFERENCIA + CHAR (13) + CHAR (10)  FROM HoleriteEventos WHERE EVENT_FUNC = FUNC_IND AND EVENT_QUEBRA = SAL_QUEBRA AND (MONTH(EVENT_COMPETENCIA) = @MES) AND YEAR(EVENT_COMPETENCIA) = @ANO AND EVENT_HOLERITE_TIPO = @SAL_HOLERITE_TIPO FOR XML PATH('')) AS EVENTOREFERENCIA,
            (SELECT EVENT_VENCIMENTO + CHAR (13) + CHAR (10)  FROM HoleriteEventos WHERE EVENT_FUNC = FUNC_IND  AND EVENT_QUEBRA = SAL_QUEBRA AND (MONTH(EVENT_COMPETENCIA) = @MES) AND YEAR(EVENT_COMPETENCIA) = @ANO AND EVENT_HOLERITE_TIPO = @SAL_HOLERITE_TIPO FOR XML PATH('')) AS EVENTOVENCIMENTO,
            (SELECT EVENT_DESCONTO + CHAR (13) + CHAR (10)  FROM HoleriteEventos WHERE EVENT_FUNC = FUNC_IND AND EVENT_QUEBRA = SAL_QUEBRA AND (MONTH(EVENT_COMPETENCIA) = @MES) AND YEAR(EVENT_COMPETENCIA) = @ANO AND EVENT_HOLERITE_TIPO = @SAL_HOLERITE_TIPO FOR XML PATH('')) AS EVENTODESCONTO
            FROM dbo.Funcionarios 
            INNER JOIN HoleriteResumoSalario  ON HoleriteResumoSalario .SAL_FUNC = FUNC_IND
            LEFT JOIN Clientes ON Clientes.CLI_IND = FUNC_EMPRESA
            WHERE (MONTH(SAL_COMPETENCIA) = @MES) AND YEAR(SAL_COMPETENCIA) = @ANO AND CLI_IND = @CLI_IND AND SAL_HOLERITE_TIPO = @SAL_HOLERITE_TIPO ORDER BY SAL_DIVISAO">
        <SelectParameters>
