            ...
            if (Node != null)
            {
                ...
                else
                {
                    if (!String.IsNullOrEmpty(Node["image"]))
                    {
                        ...
                        imagewrapper.Style.Add("Display", "none");
                    ...
                    {
                            PageTitleTitleLabel.CssClass = "descricaoGrupo";
                            //PageTitleImage.CssClass = "blueDark";
                    ...
                    else
                    {
                        ...
                        PageTitleTitleLink.CssClass = "descricaoGrupo";
                    ...
                    {
                        ((HtmlGenericControl)PageTitleWrapper.Parent.Parent).Attributes.Add("style", "border-bottom-style: solid;border-width: 5px;border-color: #336699;");
                    }
                }
            }
            else
