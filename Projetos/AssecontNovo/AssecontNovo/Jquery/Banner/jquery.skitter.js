		...
		setup: function() 
		{
				...
				if (width_info_slide < self.settings.width_skitter) {
					...
					switch (self.settings.numbers_align) {
						case 'center' : 
							...
							self.box_skitter.find(class_info).css({ 'left': self.settings.EspacoNumero }); //_vleft});
							break;
							
					    case 'right':
					        self.box_skitter.find(class_info).css({ 'left': self.settings.EspacoNumero });
			...
			else 
			{
				...
				switch (self.settings.numbers_align) {
					...
					case 'left' : 
					    self.box_skitter.find(class_info).css({ 'left': self.settings.EspacoNumero });//'15px'});
						break;
				}
